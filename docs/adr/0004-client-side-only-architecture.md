...
4. **Progressive Web App (PWA)**: Add service worker for offline caching. Rejected as the app already works offline once loaded; full PWA features (install
   prompt, etc.) add complexity for marginal benefit.
